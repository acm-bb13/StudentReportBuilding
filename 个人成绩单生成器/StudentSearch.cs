...
namespace 个人成绩单生成器
{
    public partial class StudentSearch : Form
    {
        ...
        void flush2()
        {
            ...
            string sql = "select * from studentinfo LEFT  JOIN ( select id,name FROM  classinfo) AS temp ON studentinfo.iClass = temp.id  ";
            if (textBox1.Text != "")
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string name = dataGridView1.Rows[index].Cells[9].Value.ToString();
